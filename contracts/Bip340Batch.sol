...
contract Bip340Batch {
    ...
    uint256 private constant ERRX = uint256(-1);
    ...
    function _computeSum_aiRi(uint256[] memory rxv, uint256[] memory av) internal returns (uint256, uint256) {
    ...
    function _computeSum_aieiPi(uint256 px, uint256 py, uint256[] memory rxv, bytes32[] memory mv, uint256[] memory av) internal returns (uint256, uint256) {
    ...
    function _computeSum_aisiG(uint256[] memory sv, uint256[] memory av) internal returns (uint256, uint256) {
        uint256 sumas = sv[0];
