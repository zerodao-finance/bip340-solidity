...
contract Bip340Batch {
    ...
    function _computeSum_aiRi(uint256[] memory rxv, uint256[] memory av) internal pure returns (uint256, uint256) {
    ...
    function _computeSum_aisiG(uint256[] memory sv, uint256[] memory av) internal pure returns (uint256, uint256) {
        uint256 sumas = sv[0];
